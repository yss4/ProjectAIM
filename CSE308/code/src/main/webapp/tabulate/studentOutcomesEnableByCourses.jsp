...
<html>
    <head>
        ...
        <title>Tabulate Student Outcomes enabled by Courses Page</title>
    </head>
    <body>
        <h1>Tabulate Student Outcomes enabled by Courses Page</h1>
        <%
            ...
            out.println(degreeProgram.getDegreeProgramId());
        %>
